...
import contract from "../context/MeetSci.json";
...
const Room = () => {
  ...
  const dealIDHandler = async () => {
    ...
    var refresh = setInterval(async () => {
      ...
      console.log(dealID);
      if (dealID && dealID !== "0") {
        // If your deal has already been submitted, you going to https://hyperspace.filfox.info/en/deal/<dealID>
      ...
      <div className='mb-32 grid text-center lg:mb-0 lg:grid-cols-5 lg:text-left gap-8'>
        <div>
          <button
            ...
            onClick={() => joinLobby("zjq-ltsv-owy")}
          >
            joinLobby()
          </button>
        ...
        <div>
          <button
            ...
            onClick={() => {
              console.log(`https://info-base.vercel.app/${roomId}`);
              startRecording(`https://info-base.vercel.app/${roomId}`);
            }}
          >
            startRecording()
          </button>
